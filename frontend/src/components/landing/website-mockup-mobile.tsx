...
export function WebsiteMockupMobile() {
  ...
  return (
    <div className="flex h-full w-full select-none flex-col overflow-hidden bg-[#101013] text-white" style={{ pointerEvents: "none" }}>
      ...
      <header className="flex h-[38px] items-center justify-between border-b border-white/10 px-3">
      ...
      <div className="relative h-[118px] flex-none overflow-hidden">
        <img
          src="/hvac-hero.webp"
          ...
          draggable="false"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#101013] via-transparent to-black/10" />
        <div className="absolute left-2 top-2 rounded-full border border-[#FF6B35]/30 bg-[#101013]/80 px-2 py-1 text-[5.5px] font-semibold text-[#FFC4AD] backdrop-blur">
          {t.mockup.badge}
        </div>
        <div className="absolute inset-x-2 bottom-2 flex items-end justify-between gap-1">
          <div className="flex items-center gap-1 rounded-lg border border-white/15 bg-[#101013]/80 px-1.5 py-1 text-[5.5px] font-semibold backdrop-blur">
            <CheckCircle className="h-2.5 w-2.5 text-[#FF6B35]" />
            Same-day service
          </div>
          <div className="rounded-lg bg-[#FF6B35] px-2 py-1 text-[6px] font-black text-[#101013]">4.9 Google</div>
        </div>
      </div>
      ...
      <div className="flex min-h-0 flex-1 flex-col px-3 pb-3 pt-2.5">
        ...
        <div className="mt-auto flex items-center justify-between pt-2">
          ...
          <span className="text-[5.5px] text-white/40">{t.mockup.trust}</span>
        </div>
      </div>
    </div>
  );
