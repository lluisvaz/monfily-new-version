    ...
    >
      <header className="relative z-20 flex items-center justify-between border-b border-white/10 bg-[#101013]/90 px-7 py-5 backdrop-blur-xl">
        <div className="flex items-center gap-2.5">
          <div className="grid h-8 w-8 place-items-center rounded-full bg-[#2869D6] text-[11px] font-black text-[#0B0B0D]">
            NA
          </div>
          <div>
        ...
        <div className="rounded-full bg-[#2869D6] px-3 py-2 text-[11px] font-bold text-[#0B0B0D]">
          (305) 555-0147
        </div>
      </header>
      ...
      <div className="relative grid min-h-[447px] grid-cols-[1.03fr_.97fr] overflow-hidden">
        <div className="relative z-10 flex flex-col justify-center px-8 py-8">
          <div className="mb-5 inline-flex w-fit items-center gap-2 rounded-full border border-[#2869D6]/25 bg-[#2869D6]/10 px-3 py-1.5">
            <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#2869D6]" />
            <span className="text-[11px] font-semibold text-[#AFCBFF]">{t.mockup.badge}</span>
          </div>
          ...
          <div className="mt-6 flex items-center gap-2">
            <div className="flex items-center gap-2 rounded-full bg-[#2869D6] py-2 pl-4 pr-2 text-xs font-normal text-[#0B0B0D]">
              {t.mockup.cta.viewPrices}
              <span className="grid h-6 w-6 place-items-center rounded-full bg-[#0B0B0D]">
                <ArrowRight className="h-3 w-3 text-[#2869D6]" />
              </span>
            </div>
            <div className="flex items-center gap-2 rounded-full border border-white/15 bg-[#0B0B0D]/5 px-4 py-2 text-xs font-normal text-white">
              <Phone className="h-3.5 w-3.5 text-[#2869D6]" />
            ...
            <div>
              <div className="flex gap-0.5">
                {Array.from({ length: 5 }).map((_, index) => (
                  <Star key={index} className="h-3 w-3 fill-[#2869D6] text-[#2869D6]" />
                ))}
              </div>
        ...
        <div className="relative min-h-[447px] overflow-hidden">
          ...
          <div className="absolute inset-x-4 bottom-4 grid grid-cols-2 gap-2">
            <div className="rounded-xl border border-white/15 bg-[#0B0B0D]/80 p-3 backdrop-blur-xl">
              <CheckCircle className="mb-2 h-4 w-4 text-[#2869D6]" />
            ...
            <div className="rounded-xl border border-white/15 bg-[#2869D6] p-3">
